...
import {
  ...
  Search, Filter, Grid3X3, List, Plus, MoreHorizontal, Download, Eye, ChevronDown,
} from "lucide-react"
                ...
                {filtered.map((doc) => {
                  ...
                  return (
                    <div key={doc.id} className="grid grid-cols-[2fr_1.5fr_1fr_1fr_1fr_1.5fr_auto] gap-4 items-center px-5 py-3.5 hover:bg-muted/30 transition-colors group">
                      ...
                      <span className="text-sm font-semibold text-foreground">{doc.total_amount.toFixed(2)} €</span>
